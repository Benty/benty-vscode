...
export const init = async (source) => {
...
\t]
    ...
    writeToFile(configPath, `/** @type require('pinecone-cli').Config */\nexport default ${JSON.stringify(defaultConfig, null, '\t')}`);
};
